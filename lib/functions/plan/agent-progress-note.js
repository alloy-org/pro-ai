...
export class AgentProgressNote {
  ...
  // @param {string} actionItem.title - Title of the action item
  // @param {string} actionItem.description - Optional description of the action item
  // @param {string} actionItem.type - Type of the action item
  ...
  // @param {string} artifactType - Type: "image", "note", "website", "task", or "footnote"
  ...
  // @returns {Promise<string>} - Markdown link in format [linkText](noteURL)
  // --------------------------------------------------------------------------
  ...
  //   - inline: The inline footnote reference syntax
  //   - definition: The footnote definition syntax
  // --------------------------------------------------------------------------
  ...
  //
  // @returns {Promise<string>} - The full markdown content of the note
  // --------------------------------------------------------------------------
  async getContent() {
  ...
  //
  // @returns {Object} - Note handle containing:
  ...
  //
  // @returns {Promise<Array>} - Array of section objects from the Amplenote API
  // --------------------------------------------------------------------------
  async getSections() {
  ...
  //
  // @returns {Promise<string>} - The URL of the note
  // --------------------------------------------------------------------------
  async getURL() {
  ...
  // --------------------------------------------------------------------------
  // Extract section content by finding boundaries between sections
  //
  // @param {Array} sections - Array of section objects from getNoteSections
  ...
  // @returns {Promise<string>} - The content of the section (without the heading)
  // --------------------------------------------------------------------------
